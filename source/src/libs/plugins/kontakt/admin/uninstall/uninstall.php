...
function initialize($dObj)
{
	...
	if ( $_POST['doit'] == "Ja" )
	{
	    ...
	    {
	        $text = message(PLUGIN_PATH,"kontakt","uninstall_true",$SID);
	    }
	    else $text = message(PLUGIN_PATH,"kontakt","uninstall_false",$SID);
	}
	else $text = message(PLUGIN_PATH,"kontakt","uninstall_false",$SID);
	...
	$ground_tpl->insertVar("name","Kontakt-Formular");
