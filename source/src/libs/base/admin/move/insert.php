...
function initialize($dObj)
{
	...
	//Standard Nachricht
	$text = message(BASE_PATH,"move","insert_false",$SID);

	//Templates laden
	$ground_tpl->load("ground");

	if ( $_SESSION['cut_id'] > 0 )
	{
		//Neuen Menüpunkt einfügen
		$sql->move_item($_SESSION['cut_id'],$_GET['parent']);
	
		unset($_SESSION['cut_id']);
		$text = message(BASE_PATH,"move","insert_true",$SID);
	}
