...
//Home Pfad
define("ABS_PATH",dirname(str_replace('//','/', str_replace('\\','/', (php_sapi_name()=='cgi'||php_sapi_name()=='isapi' ||php_sapi_name()=='cgi-fcgi')&&($_SERVER['ORIG_PATH_TRANSLATED']?$_SERVER['ORIG_PATH_TRANSLATED']:$_SERVER['PATH_TRANSLATED'])? ($_SERVER['ORIG_PATH_TRANSLATED']?$_SERVER['ORIG_PATH_TRANSLATED']:$_SERVER['PATH_TRANSLATED']):($_SERVER['ORIG_SCRIPT_FILENAME']?$_SERVER['ORIG_SCRIPT_FILENAME']:$_SERVER['SCRIPT_FILENAME'])))));
#define("REL_PATH",( (dirname($_SERVER['PHP_SELF']) == "/") ? "." : dirname($_SERVER['PHP_SELF']) ));
define("REL_PATH",( (dirname($_SERVER['PHP_SELF']) == "/") ? "" : dirname($_SERVER['PHP_SELF']) ));
...
} else die('ERROR: Beeco Base-Folder not found!');

//Startfunktion einbinden
require(BASE_PATH.'/includes/actions/index.actions.php');
require(BASE_PATH.'/index.php');
$dObj = init();   # Grundaktionen für den Start
init_main($dObj); # Lädt den Inhalt
